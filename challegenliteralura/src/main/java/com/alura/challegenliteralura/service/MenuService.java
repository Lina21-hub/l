package com.alura.challegenliteralura.service;

import com.alura.challegenliteralura.api.PeticionAPI;
import com.alura.challegenliteralura.util.JsonParser;
import com.alura.challegenliteralura.modelo.Autor;
import com.alura.challegenliteralura.modelo.Idioma;
import com.alura.challegenliteralura.modelo.Libro;
import com.alura.challegenliteralura.modelo.LibroRecord;
...
public class MenuService {
    ...
    public List<LibroRecord> obtenerLibrosApi() {
        ...
        librosObtenidos = jsonParser.
                parsearLibros(peticionAPI.obtenerDatos(titulo));
